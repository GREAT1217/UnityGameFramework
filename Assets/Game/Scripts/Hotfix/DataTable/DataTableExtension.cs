...
namespace Game.Hotfix
{
    ...
    {
        public const string DataRowClassNameSpace = "Game.Hotfix";
        ...
        public static void LoadDataTable(this DataTableComponent dataTableComponent, string dataTableName, string dataTableAssetName, object userData)
        {
            ...
            string dataRowClassName = string.Format("{0}.{1}{2}", DataRowClassNameSpace, DataRowClassPrefixName, splitedNames[0]);
