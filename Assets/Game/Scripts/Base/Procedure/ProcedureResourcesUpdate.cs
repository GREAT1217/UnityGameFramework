...
namespace Game
{
    public class ProcedureResourcesUpdate : ProcedureBase
    {
        ...
        private NativeUpdateForm m_NativeUpdateForm = null;
        ...
        {
            if (m_NativeUpdateForm != null)
            {
                Object.Destroy(m_NativeUpdateForm.gameObject);
                m_NativeUpdateForm = null;
            }
        ...
        private void StartUpdateResources(object userData)
        {
            if (m_NativeUpdateForm == null)
            {
                m_NativeUpdateForm = Object.Instantiate(GameEntry.BuiltinData.NativeUpdateFormTemplate);
            }
        ...
        private void RefreshProgress()
        {
            ...
            m_NativeUpdateForm.SetProgress(progressTotal, descriptionText);
        }
